...
async function weatherData(city) {
  ...
  for (let i = 1; i < 8; i++) {
    ...
    if (
      ...
      document.querySelector(`.i${i}`).src = "moderate rain.svg";
    } else if (description == "Partly cloudy") {
      document.querySelector(`.i${i}`).src = "partly cloudy.svg";
    } else if (description == "Sunny") {
      document.querySelector(`.i${i}`).src = "Sunny.svg";
    } else if (description == "Heavy rain") {
      document.querySelector(`.i${i}`).src = "heavy rain.svg";
    } else if (description == "Overcast") {
      document.querySelector(`.i${i}`).src = "Overcast.svg";
    }
  }
}
